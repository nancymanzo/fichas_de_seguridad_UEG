...
fecha_inicial <- "2023-02-11"
fecha_final <- "2023-02-17"


#Semana anterior
fecha_inicial_2 <- "2023-02-04"
fecha_final_2 <- "2023-02-10"
```
...
quejas %>% 
  filter(between(Fecha_queja, as.Date('2023-02-11'), as.Date('2023-02-17'))) %>% 
...
conductas_descendente_anterior[3,2]->total_delito_3_anterior
...
De **`r format(as.Date(fecha_inicial), "%d de %B")`** a **`r format(as.Date(fecha_final), "%d de %B de %Y")`** se han contabilizado un total de **`r total_quejas_por_conducta`** conductas denunciadas: **`r total_delito_1`** por **`r tolower(delito_1)`**.
...
De **`r format(as.Date(fecha_inicial_2), "%d de %B")`** a **`r format(as.Date(fecha_final_2), "%d de %B de %Y")`** por área de adscripción del presunto agresor se contabilizó: **`r total_ads_1_anterior`** de la **`r ads_1_anterior`**, **`r total_ads_2_anterior`** de la **`r ads_2_anterior`** y **`r total_ads_3_anterior`** de la **`r ads_3_anterior`**.
 

De **`r format(as.Date(fecha_inicial), "%d de %B")`** a **`r format(as.Date(fecha_final), "%d de %B de %Y")`** por área de adscripción del presunto agresor se contabilizó: **`r total_ads_1`** de la **`r ads_1`**.
...
De **`r format(as.Date(fecha_inicial), "%d de %B")`** a **`r format(as.Date(fecha_final), "%d de %B de %Y")`** un total de **`r tolower(total_policia)`** mujeres víctimas de violencia por parte de personal policial han interpuesto quejas, las cuales se clasifican de la manera siguiente: (**`r policia_total_1`** es **`r tolower(policia_1)`**).
 
